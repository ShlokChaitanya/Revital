...
import image1 from '../Assets/DP/image03.webp'
import image2 from '../Assets/DP/raunak.webp'
import image3 from '../Assets/DP/image01.webp'
import image4 from '../Assets/DP/anant.webp'
...
const testimonials = [
    ...
    { id: 4, name: 'Anant Solanki', status: 'Host', title: 'Smooth Experience!', quote: 'As an events host, my role is all about creating memorable experiences and ensuring that everything runs smoothly behind the scenes. I thrive on engaging with diverse audiences, keeping the energy high, and making sure that every event is a success. From coordinating with speakers and performers to managing logistics and overseeing the overall flow of the event, I take pride in orchestrating seamless and impactful experiences for our attendees.', image: image4 },
];
